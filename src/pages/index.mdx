...
This is the public version of a recent smart contract securit audit for the [Avastars NFT project](https://avastars.io/). The primary audit work was conducted between 12/01/20 and 05/02/20. Previous versions of the audit reports were delivered directly for the team's internal review in PDF format. Issues were addressed through ongoing communication with Avastars development team. This public version is revised for a wider audience, converted to a more accessible web format, and updated with additional diagrams and clarifying language.
...
For a full view of the audit timeline please refer to [Version History](#a05-version-history). The primary elements of this process include a Preliminary Assessment Report delivered on 12/01/20 based on commit [1ea95a9](https://github.com/Dapp-Wizards/Avastars-Contracts/commit/1ea95a92d0859610533f40acd1df68a91353c0ea), the Full Audit Report delivered on 28/01/20 and based on commit [b8220ee](https://github.com/Dapp-Wizards/Avastars-Contracts/commit/b8220ee9335167fd3e5d6c5691b20a3a4bb2a3dc), and a Post-Audit Follow-Up Report delivered on 5/02/20 and based on commit [b2ac915](https://github.com/Dapp-Wizards/Avastars-Contracts/commit/b2ac9159a034c27b3ccad98fa806af08be37a842). Please see [Smart Contracts Reviewed](#a01-smart-contracts-reviewed) for a full description of the audit scope. Note that any commits after b2ac915 are not considered in this report.
...
Avastars attempts to radically extend the metadata associated with NFT projects by taking the bold action of storing re-assembleable svg layers on-chain. The ambition of such a project attempts to solve an ongoing issue in NFT projects where the user owns an arbitrary data string but none of the art or other cultural associattions that make up much of their appeal as collectables.
...
The maxmium Avastar supply is bounded by the following constraints:
...
- _S0: Promo season number_
- _S1-5: Season number_
- _G1-5 : Generation number _
- _P: Primes, including Promos_
- _R: Replicants_

##### Example Lifecyle of the Token Minting Process
...
The Avastars project currently has 3 contracts live at on mainnet (with a 4th planned). The code base contains 17 core Avastars contracts, including 2 interfaces. In addition, the code base inherits 5 contracts, 4 libraries, and 5 interfaces from the OpenZeppelin smart contract repository (v2.4.0). All Avastar contracts have the ability to be paused, upgraded, and modified by various permissioned administrator-level addresses.
...
- The vast majority of issues are relatively minor in nature. Many of the High and Medium severity issues were fixed will minimal changes to the code base
