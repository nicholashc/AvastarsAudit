...
- Downtime and maintainance requirements for backend nodes and associated scripts
...
This issue is partially mitigated by the Avastars team's plan to run multiple `minters`. In practice, the number of minters could be scaled to match demand. However, the associated key managementment risks would also increase.
