...
It's possible for the `sysAdmin` to accidentally or maliciously set the address of new contract in to `address(0)` when calling the `upgradeContract()` function.
